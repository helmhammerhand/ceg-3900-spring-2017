...
public class WordListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getApplicationContext().registerReceiver(receiver, new IntentFilter(QueryPassSecurityService.PASSWORD_CHECK_FINISHED));
    ...
    private void startCommonWordsService()
    {
        ...
        serviceIntent.putExtra("type", QueryPassSecurityService.TYPE_WORD_LIST_CHECK);
