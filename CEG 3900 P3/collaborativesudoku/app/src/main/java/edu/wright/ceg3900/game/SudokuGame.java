...
import edu.wright.ceg3900.firebase.MessagingPostService;
import edu.wright.ceg3900.game.command.ClearAllNotesCommand;
import edu.wright.ceg3900.game.command.AbstractCommand;
import edu.wright.ceg3900.game.command.CommandStack;
import edu.wright.ceg3900.game.command.EditCellNoteCommand;
import edu.wright.ceg3900.game.command.FillInNotesCommand;
import edu.wright.ceg3900.game.command.SetCellValueCommand;
...
public class SudokuGame {
	...
	public void onCommandRecieved(AbstractCommand c)
	{
	...
	private void executeCommand(AbstractCommand c) {
		...
		Log.d("SudokuGame","Executed Command");

		try {
			System.out.println(c.getCommandClass() + " " + c.toString());
			Intent serviceIntent = new Intent(getActivity(), MessagingPostService.class);
			serviceIntent.putExtra("c", MessagingPostService.toString(c));
