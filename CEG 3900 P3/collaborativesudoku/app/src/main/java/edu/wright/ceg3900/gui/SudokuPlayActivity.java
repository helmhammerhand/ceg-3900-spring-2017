...
public class SudokuPlayActivity extends Activity {
	...
	public static SudokuGame currentGame;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		FirebaseMessaging.getInstance().subscribeToTopic("sudoku");
		Log.d("SudokuPlayActivity","Subscribed");
		...
		if (savedInstanceState == null) {
			...
			//TODO remove the database (ie manually start a particular sudoku game)
			// mSudokuGame = mDatabase.getSudoku(mSudokuGameID);
			mSudokuGame = mDatabase.getSudoku(1);
			mSudokuGame.reset();
			mSudokuGame.setActivity(this);
			currentGame = mSudokuGame;
			//TODO set up firebase messaging

			//TODO send game state request message
