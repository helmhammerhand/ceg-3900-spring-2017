...
public class AndroidUtils {
	...
	public static void setThemeFromPreferences(Context context) {
		...
		if (theme.equals("default")) {
			...
			context.setTheme(R.style.AppTheme_PaperI);
		} else if (theme.equals("paperii")) {
			context.setTheme(R.style.AppTheme_PaperII);
		} else if (theme.equals("light")) {
			context.setTheme(R.style.AppTheme_Light);
        } else if (theme.equals("paperlighti")) {
            context.setTheme(R.style.AppTheme_PaperLightI);
        } else if (theme.equals("paperlightii")) {
            context.setTheme(R.style.AppTheme_PaperLightII);
		} else {
			context.setTheme(R.style.AppTheme_Default);
		}
	}
